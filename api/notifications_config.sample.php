...
return [
    ...
    'telegram_api_base' => '', // необязательно: замена хоста "https://api.telegram.org" (например свой бесплатный
                              // Cloudflare Worker-реверс-прокси) — для санкционных хостингов проще прокси-сервера
