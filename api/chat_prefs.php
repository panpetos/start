...
const PREF_RULES = [
    ...
    // Выбранный узор-обои (id из встроенного набора; сами SVG-узоры лежат в chat.html,
    // здесь храним только короткий идентификатор — значение нельзя превратить в CSS).
    'doodle_pattern' => '/^[a-z0-9_-]{1,24}$/',
    // Свои цвета пузырей
