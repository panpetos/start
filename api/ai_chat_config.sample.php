...
return [
    ...
    //
    // Чтобы включить: в консоли Yandex Cloud, в ТОМ ЖЕ каталоге, что в folder_id,
    // подключите сервис Search API, а сервисному аккаунту этого ключа выдайте роли
    // search-api.webSearch.user и search-api.executor. Ключ менять не нужно — поиск
