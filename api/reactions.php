...
// ВАЖНО: этот список — единственный источник правды. Чат берёт его из ответа
// action=list (поле allowed) и строит сетку смайлов по нему. Раньше список был
// продублирован в chat.html; я расширил там сетку до 24 смайлов, а здесь осталось
// 8 — и половина смайлов отвечала «Такую реакцию поставить нельзя».
