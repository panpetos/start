...
try {
    ...
    if ($action === 'link-code') {
        ...
        // Имя бота — чтобы дать кликабельную ссылку прямо в чат с ботом (задача #46). Код всё
        // равно приходится копировать и вставлять вручную: ?start=<код> у части клиентов сам
        // подставляет его в переписку, а у части — нет, так что полагаться на это нельзя.
